...
websocket_urlpatterns = [
    ...
    re_path(r'ws/adminnotifications/$',consumers.AdminNotificationConsumer.as_asgi()),
    re_path(r'ws/deliverynotifications/$',consumers.DeliveryNotificationConsumer.as_asgi()),
    re_path(r'ws/restaurantnotifications/$',consumers.RestaurantNotificationConsumer.as_asgi()),
]