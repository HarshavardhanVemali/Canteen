...
from .models import CustomUser, DeliveryPerson, RegularUser, Admin,FailedLoginAttempts,EmailVerification,Menu,SubMenu,Item,Cart,Prices,Order,Refund,OrderItem,Payment,OrderAdditionalCharges,DeliveryLocation,Restaurant,UserDeviceToken,AdminNotification,UserNotification,RestaurantNotification,DeliveryPersonNotification
...
class ItemAdmin(admin.ModelAdmin):
    list_display=('id','menu','submenu','resturant','count','item_name','type','price','rating','is_available','preview_image')
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ('transaction_id', 'user', 'amount', 'status', 'payment_date','created_at')
...
@admin.register(OrderAdditionalCharges)
...
class NotificationAdmin(admin.ModelAdmin):
    list_display=('user','title','message','created_at','delete_after','related_order','is_read')

admin.site.register(AdminNotification,NotificationAdmin)
admin.site.register(UserNotification,NotificationAdmin)
admin.site.register(RestaurantNotification,NotificationAdmin)
admin.site.register(DeliveryPersonNotification,NotificationAdmin)
